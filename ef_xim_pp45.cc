...
ef_xim_pp45::ef_xim_pp45(const TString& analysisName, const TString& treeName) : KAbstractAnalysis(analysisName, treeName),
...
bool ef_xim_pp45::analysis(HEvent * fEvent, Int_t event_num, HCategory * pcand, Int_t cand_size, HCategory * vcand, Int_t vect_size)
{
//     printf("%d  %d\n", cand_size, vect_size);
...
int ef_xim_pp45::Configure(int argc, char ** argv)
{
    int c;
    optind = 1;
